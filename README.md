...
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------- |
| **Pokemon Search**        | Client-side app that fetches and displays Pokémon data.<br/><br/>**Key Features:**<br/>• Fetches data from a REST API using Fetch API<br/>• Handles async state and loading states<br/>• Dynamic UI rendering<br/>• Error handling | HTML, CSS, JS, [Fetch API](https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API)                                                                                                    | [Demo](https://pokemonsearchcode.netlify.app) | [GitHub](https://github.com/pedromst2000/pokemon_search)        | [Issues](https://github.com/pedromst2000/pokemon_search/issues)        |
| **Einstein Tribute Page** | Responsive landing page focused on UI/UX and performance.<br/><br/>**Key Features:**<br/>• Built with React + TypeScript<br/>• Animated UI with Framer Motion<br/>• Client-side routing with React Router<br/>• Responsive and accessible design | **Node.js, React, TypeScript, Tailwind CSS**<br/><br/>_Auxiliary: Vite, [React Router](https://reactrouter.com/start/framework/routing), [Framer Motion](https://www.framer.com/motion/)_ | :rocket: Coming Soon                          | [GitHub](https://github.com/pedromst2000/Einstein-Tribute-Page) | [Issues](https://github.com/pedromst2000/Einstein-Tribute-Page/issues) |
...
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------ | -------------------------------------------------------------- | --------------------------------------------------------------------- |
| **CrossSum App**   | Desktop app for digit-sum calculations with a focus on testing and code quality.<br/><br/>**Key Features:**<br/>• Tkinter GUI interface<br/>• Unit and property-based testing with pytest and Hypothesis<br/>• CI pipeline with linting and coverage<br/>• Modular, clean architecture | **Python, Tkinter**<br/><br/>_Auxiliary: pytest, [pytest-mock](https://pytest-mock.readthedocs.io/en/latest/), [pytest-cov](https://pytest-cov.readthedocs.io/en/latest/), [Hypothesis](https://hypothesis.readthedocs.io/en/latest/), [flake8](https://flake8.pycqa.org/en/latest/), [yamllint](https://yamllint.readthedocs.io/en/stable/), [Black](https://black.readthedocs.io/en/stable/), [mypy](https://mypy.readthedocs.io/en/stable/), pyinstaller_ | [Demo](https://youtu.be/I1cHkolX1NI) | [GitHub](https://github.com/pedromst2000/Cross_Sum_Number_App) | [Issues](https://github.com/pedromst2000/Cross_Sum_Number_App/issues) |
| **PhotoShow**      | Desktop photo management app built with MVC architecture.<br/><br/>**Key Features:**<br/>• Authentication system with bcrypt<br/>• Database integration with SQLite and SQLAlchemy<br/>• MVC layered design pattern<br/>• Image processing with Pillow | **Python, Tkinter, SQLite, SQLAlchemy, pyinstaller**<br/><br/>_Auxiliary: pytest, pytest-mock, pytest-cov, flake8, yamllint, Black, [Pillow](https://pillow.readthedocs.io/en/stable/), [bcrypt](https://pypi.org/project/bcrypt/)_                                                                                                                                                                                                                          | :clapper: Coming Soon                | [GitHub](https://github.com/pedromst2000/PhotoShow)            | [Issues](https://github.com/pedromst2000/PhotoShow/issues)            |
| **GrubSnake Game** | Arcade Snake game focused on gameplay logic and modular design.<br/><br/>**Key Features:**<br/>• Game loop built with Pygame<br/>• Dynamic snake growth mechanics<br/>• Score tracking system<br/>• Keyboard controls with WASD and arrow keys | **Python, Pygame**                                                                                                                                                                                                                                                                                                                                                                                                                                           | :clapper: Coming Soon                | [GitHub](https://github.com/pedromst2000/GrubSnake)            | [Issues](https://github.com/pedromst2000/GrubSnake/issues)            |
